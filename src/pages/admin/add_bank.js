    ...
    return (
      <div>
        ...
        <div className="smx:px-[0%] p-3 flex justify-between">
          ...
          <div className="mb-4">
            <input className="appearance-none border rounded-md w-[110px] lg:w-[230px] py-2 md:py-3 px-4 bg-gray-100 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="particuliers" type="text" placeholder="Particuliers" />
          </div>
          <div className="mb-4">
            <input className="appearance-none border rounded-md w-[110px] lg:w-[230px] py-2 md:py-3 px-4 bg-gray-100 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="professionnels" type="text" placeholder="Professionnels" />
          </div>
          <div className="mb-4">
            <input className="appearance-none border rounded-md w-[110px] lg:w-[230px] py-2 md:py-3 px-4 bg-gray-100 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="entreprise" type="text" placeholder="Entreprise" />
          </div>
        </div>
      </div>
    );
      ...
      <div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="mx-5 mb-4 w-[90%] lg:w-[900px] lg:pr-[450px]">
              ...
              <div className="bg-gray-100 w-full p-4 rounded-md border flex items-center">
                ...
                />
                {preview && (
                  <img src={preview} alt="Preview" className="mr-5 rounded-md" style={{ maxWidth: '50px', height: 'auto' }} />
                )}
        ...
        <div>
          <div className="py-6 smx:border-t-4 md:mx-16 flex items-center justify-center gap-14">
            ...
            <div className="flex items-center justify-center gap-4 text-[15px] sm:text-xl md:text-3xl">
              <AiOutlineInfoCircle className=" font-bold"/>
              <h3 className="font-bold">Informations relatives aux prestations tarifaires</h3>
            </div>
          ...
          <div className="px-[5%] lgx:px-64 flex-col items-center mb-8">
            <div className="lg:flex justify-between mb-3">
              <div className="w-full lg:w-[280px] mb-6 font-semibold bg-green-700 text-white">
                <h2 className="p-4 w-full flex justify-center">Gestion et tenue de compte</h2>
              </div>
              <div className="smx:hidden mb-3">
                <h2 className="w-[230px] p-4 text-gray-700 font-bold flex justify-center">Particuliers</h2>
              </div>
              <div className="smx:hidden mb-3">
                <h2 className="w-[230px] p-4 text-gray-700 font-bold flex justify-center">Professionnels</h2>
              </div>
              <div className="smx:hidden mb-3">
                <h2 className="w-[230px] p-4 text-gray-700 font-bold flex justify-center">Entreprise</h2>
              </div>
            </div>
          ...
          <div className="px-[5%] lgx:px-64 flex-col items-center  mb-8">
            <div className="lg:flex justify-between mb-3">
              <div className="w-full lg:w-[280px] mb-6 font-semibold bg-green-700 text-white">
                <h2 className="p-4 w-full flex justify-center">Opérations de paiement</h2>
              </div>
              <div className="smx:hidden mb-3">
                <h2 className="w-[230px] p-4 text-gray-700 font-bold flex justify-center">Particuliers</h2>
              </div>
        ...
        <div>
          <div className="py-6 smx:border-t-4 md:mx-16 flex items-center justify-center gap-14">
            ...
            <div className="flex items-center justify-center gap-4 text-lg sm:text-xl md:text-3xl">
              <AiOutlineInfoCircle className=" font-bold"/>
              <h3 className="font-bold">Informations sur la Direction Générale</h3>
            </div>
          ...
          <div className="flex flex-col items-center">
              ...
              <div className="mx-5 mb-4 w-[90%] lg:w-[900px]">
                ...
                <div className="bg-gray-100 w-full px-4 py-3 rounded-md border flex items-center">
                  ...
                  <select id="wilaya" name="wilaya" className="bg-gray-100 outline-none block w-full hover:border-gray-500 px-4 py-2 pr-8 rounded-2xl leading-tight focus:outline-none focus:shadow-outline" value={selectedWilaya} onChange={handleWilayaChange}>
