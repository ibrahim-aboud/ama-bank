  ...
  return (
    <div className="flex flex-col items-center h-screen mt-14">
      <div className="flex items-center mb-20">
        <div className="mx-5 mb-4 w-[90%] lg:w-[900px]">
          ...
          <div className="bg-gray-100 px-4 py-2 rounded-md border flex items-center w-full">
            ...
            <select id="bank" name="bank" className="bg-gray-100 outline-none block w-full hover:border-gray-500 px-4 py-2 pr-8 rounded-2xl leading-tight focus:outline-none focus:shadow-outline">
        ...
        <div>
          <a href="/admin/add_bank" className="rounded-xl px-8 py-4 mt-4 ml-10 font-semibold bg-black text-white shadow-xl hover:bg-green-600 disabled:bg-slate-900 flex items-center hover:ease-in-out duration-300">
            Ajouter une banque
      ...
      <div className="w-full">
        <BankListElement name="Natixis Algérie" logo_src="/assets/logos/logo.png" />
        <BankListElement name="Natixis Algérie" logo_src="/assets/logos/logo.png" />
        <BankListElement name="Natixis Algérie" logo_src="/assets/logos/logo.png" />
        <BankListElement name="Natixis Algérie" logo_src="/assets/logos/logo.png" />
